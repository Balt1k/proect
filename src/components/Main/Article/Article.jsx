        ...
        return (
          <>
            ...
            <p className={styles.MainText2}>Мы изготавливаем и устанавливаем мебель созданную по вашим идеям. Цена будет зависеть от 
              выбранного вами материала и сложности работы. Свяжитесь с нами в разделе "Обратная связь"
              для получения подробностей. Также на этой странице вы можете ознакомиться с нашими прошлыми проектами
            </p>
